  ...
  const featuredProjects = [
    {
      ...
      tags: ["AI", "Health", "iOS", "Product Management"]
    },
    {
      ...
      tags: ["Social Impact", "Safety", "Mobile App", "UI/UX"]
    }
  ];

  return <main className="page-container">
      <section className="flex flex-col md:flex-row items-center md:items-start gap-8 pb-12 pt-6 md:pt-10 mx-0 px-[34px] py-[60px]">
        <div className="flex-shrink-0">
          <div className="w-48 h-48 md:w-64 md:h-64 overflow-hidden rounded-full border-2 border-border shadow-sm">
      ...
      <section className="space-y-6 py-10 border-t border-border">
        ...
        <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
          {featuredProjects.map((project, index) => (
            <div key={index} className="group rounded-md border border-border p-6 transition-all hover:border-foreground/20 hover:bg-accent/40">
